namespace Breakbot404.Forms
{
    partial class WindowMain
    {
		...
		private void InitializeComponent()
		{
			...
			this.button_import.Location = new Point(835, 567);
			...
			this.button_remove.Location = new Point(916, 596);
			...
			this.label_info_samplesPerPixel.Location = new Point(6, 310);
			...
			// 
			this.numericUpDown_samplesPerPixel.Location = new Point(109, 308);
			...
			this.label_info_frameRate.Location = new Point(6, 339);
			...
			// 
			this.numericUpDown_frameRate.Location = new Point(124, 337);
			...
			this.button_export.Location = new Point(916, 567);
			...
			// button_reload
			// 
			this.button_reload.Location = new Point(835, 596);
			...
			// button_colorCaret
			// 
			this.button_colorCaret.BackColor = Color.Red;
			...
			// 
			this.numericUpDown_caretWidth.Location = new Point(124, 279);
			...
			this.label_info_caretWidth.Location = new Point(6, 281);
