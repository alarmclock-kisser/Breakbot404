namespace Breakbot404.Forms
{
    public partial class WindowMain : Form
    {
        ...
        private void WindowMain_Load(object? sender, EventArgs e)
        {
            ...
            this.ViewModel.Bind_Elements_Playback(this.button_playback, this.button_pause, this.textBox_timestamp, this.button_record, this.textBox_recordingTime, this.vScrollBar_volume, this.label_volume);
            this.ViewModel.Bind_Elements_IO(this.button_import, this.button_export, this.button_remove, this.comboBox_format, this.comboBox_bits, this.button_browse, this.label_workingDir);
