...
namespace Breakbot404.Core
{
    ...
    {
        // Fields
        public string ExportDirectory { get; set; } = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyMusic), "_BreakBot404", "Breakbot404_Exports");
        ...
        public async Task<string?> ExportMp3Async(AudioObj audio, int bitrate = 192, int maxWorkers = 4, string? outDir = null)
        {
        ...
        public async Task<string?> ExportWavAsync(AudioObj audio, int bitDepth = 24, string? outDir = null)
        {
